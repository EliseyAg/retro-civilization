...
namespace RenderEngine
{
    ...
    void ShaderProgram::set_matrix3(const std::string& name, const glm::mat3& matrix) const
    {
    ...
    void ShaderProgram::set_float(const std::string& name, const float value) const
    {
        glUniform1f(glGetUniformLocation(m_id, name.c_str()), value);
    }

    void ShaderProgram::set_int(const std::string& name, const int integ) const
    {
        glUniform1i(glGetUniformLocation(m_id, name.c_str()), integ);
    }
}